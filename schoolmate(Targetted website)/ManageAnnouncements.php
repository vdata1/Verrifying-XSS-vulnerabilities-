<?php
 ...
 if($_POST["addannouncement"] == 1 && $_POST["title"] != "" && $_POST["message"] != "")
 {
   ...
   $query = mysql_query("INSERT INTO schoolbulletins VALUES('', \"".htmlspecialchars($_POST[title])."\", \"".htmlspecialchars($_POST[message])."\", \"".htmlspecialchars($_POST[date])."\")")
 ...
 {
  $query = mysql_query("UPDATE `schoolbulletins` SET `title`= \"".htmlspecialchars($_POST[title])."\", `message`= \"".htmlspecialchars($_POST[message])."\", `bulletindate`='".converttodb($_POST["date"])."' WHERE `sbulletinid`= \"".htmlspecialchars($_POST[announcementid])."\" LIMIT 1")
