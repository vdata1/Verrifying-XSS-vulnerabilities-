...
<td>
 ...
 <tr class='even'>
  ...
  <td align='left'>
   <input type='text' value= \"".htmlspecialchars($schoolname)."\" maxlength='50' name='schoolname' size=40>
  </td>
 </tr>
 <tr class='even'>
  <td align='right'>
  ...
  <td align='left'>
   <input type='text' value= \"".htmlspecialchars($address)."\" name='schooladdress' maxlength='50' size=40>
  </td>
 </tr>
 <tr class='even'>
  <td align='right'>
  ...
  <td align='left'>
   <input type='text' value=  \"".htmlspecialchars($phone)."\" name='schoolphone' maxlength='14'>
  </td>
 </tr>
 <tr class='even'>
  <td align='right'>
  ...
  <td align='left'>
   <input type='text' value=  \"".htmlspecialchars($numsemesters)."\"  name='numsemesters' maxlength='3' size=3>
  </td>
 </tr>
 <tr class='even'>
  <td align='right'>
  ...
  <td align='left'>
   <input type='text' value= \"".htmlspecialchars($numperiods)."\"  name='numperiods' maxlength='3' size=3>
  </td>
 </tr>
 <tr class='even'>
  <td align='right'>
 ...
 <tr class='even'>
  ...
  <td align='left'>
   <textarea name='sitetext' cols=40 rows=10>\"".htmlspecialchars($sitetext)."\"</textarea>
  </td>
 </tr>
 <tr class='even'>
  <td align='right' valign='top'>Today's Message:</td>
  <td align='left'>
   <textarea name='sitemessage' cols=40 rows=10> \"".htmlspecialchars($sitemessage)."\"</textarea>
  </td>
  </tr>
 </table>
<br>
