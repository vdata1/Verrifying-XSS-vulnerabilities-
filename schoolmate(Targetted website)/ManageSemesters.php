<?php
 ...
 if($_POST["addsemester"] == 1 && $_POST["term"] != "" && $_POST["title"] != "" && $_POST["startdate"] != "" && $_POST["middate"] != "" && $_POST["enddate"] != "")
 {
  ...
  $query = mysql_query("INSERT INTO semesters VALUES('', \"".htmlspecialchars($_POST[term])."\", \"".htmlspecialchars($_POST[title])."\", \"".htmlspecialchars($_POST[startdate])."\", \"".htmlspecialchars($_POST[middate])."\",\"".htmlspecialchars($_POST[enddate])."\", \"".htmlspecialchars($_POST[half])."\")")
 ...
 if($_POST["editsemester"] == 1 && $_POST['term'] != "" && $_POST["title"] != "" && $_POST["startdate"] != "" && $_POST["middate"] != "" && $_POST["enddate"] != "")
 {
  ...
  $_POST["middate"] = converttodb($_POST["middate"]);
  $_POST["enddate"] = converttodb($_POST["enddate"]);
  $query = mysql_query("UPDATE `semesters` SET `title`=\"".htmlspecialchars($_POST[title])."\", `startdate`= \"".htmlspecialchars($_POST[startdate])."\", `midtermdate`= \"".htmlspecialchars($_POST[middate])."\", `enddate`= \"".htmlspecialchars($_POST[enddate])."\", `type`= \"".htmlspecialchars($_POST[half])."\" WHERE `semesterid`= \"".htmlspecialchars($_POST[semesterid])."\" LIMIT 1")
...
print("\n</center>
  ...
  <input type='hidden' name='page2' value=\"".htmlspecialchars($page2)."\">
  <input type='hidden' name='onpage' value=\"".htmlspecialchars($_POST[onpage])."\">
