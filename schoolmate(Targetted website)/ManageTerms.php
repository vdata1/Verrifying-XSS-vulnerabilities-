<?php
 ...
 if($_POST["editterm"] == 1 && $_POST["startdate"] != "" && $_POST["title"] != "" && $_POST["enddate"] != "")
 {
  $_POST["startdate"] = converttodb($_POST["startdate"]);
  $_POST["enddate"] = converttodb($_POST["enddate"]);
  $query = mysql_query("UPDATE `terms` SET `title`='$_POST[title]', `startdate`='$_POST[startdate]', `enddate`='$_POST[enddate]' WHERE `termid`= \"".htmlspecialchars($_POST[termid])."\" LIMIT 1")
